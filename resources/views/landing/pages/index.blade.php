...
<!-- START HOME -->
	<section id="home" class="home_bg"
        style="background-image: url(https://th.bing.com/th/id/OIP.pfi0VK2gRJNVHgSlLlkVtAHaFN?w=254&h=180&c=7&r=0&o=7&pid=1.7&rm=3); background-size:cover;background-position:center;">
			<body class="background-image: url(https://th.bing.com/th/id/OIP.pfi0VK2gRJNVHgSlLlkVtAHaFN?w=254&h=180&c=7&r=0&o=7&pid=1.7&rm=3)">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1 col-sm-12 col-xs-12 text-center">
					<div class="hero-text">
						<h2>Your Tourism Solution</h2>
						<p>Solusi Terbaik buat perjalan wisata anda bersama keluarga tercinta.</p>
						<div class="home_btn">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6 col-xs-12">
					<div class="single_search">
						<select>
							...
							<option value="1">Taman Ancol</option>
							<option value="1">Pantai Lombok</option>
				...
				<div class="col-lg-3 col-sm-6 col-xs-12">
					<div class="single_search">
						<select>
							<option value="1">Destinations Type</option>
				...
				<div class="col-lg-3 col-sm-6 col-xs-12">
					<div class="single_search">
						<select>
							<option value="1">Destinations Status</option>
	...
	<section class="template_property">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{ asset('/storage/landing/assets/img/property/3.jpg') }}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
	...
	<section class="template_property section-padding">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="/storage/landing/assets/img/property/4.jpg" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
	...
	<section data-stellar-background-ratio="0.3" class="our_testimonial section-padding"
		style="background-image: url(/storage/landing/assets/img/bg/testimonial-bg.jpg);  background-size:cover;background-position:center;">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="partner  wow fadeInRight">
						<a href="#"><img src="/storage/landing/assets/img/partner/1.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/2.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/3.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/4.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/5.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/1.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/2.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/3.png" alt="image"></a>
						<a href="#"><img src="/storage/landing/assets/img/partner/4.png" alt="image"></a>
