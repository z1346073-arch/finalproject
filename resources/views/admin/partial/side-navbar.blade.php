          ...
          <ul class="navbar-nav flex-column  ">
              ...
              <li>
                  <div class="text-center py-5 upgrade-ui ">
                      <div>
                          <img src="{{ asset('storage/admin/assets/images/avatar/avatar-1.jpg') }}" alt=""
      ...
      <div class="offcanvasNav offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
          ...
          <div class="offcanvas-body p-0">
              <ul class="navbar-nav flex-column  ">
                  <!-- Nav item -->
                  <li class="nav-item">
                      <a class="nav-link" href="../index.html"><span class="nav-icon"><svg
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu flex-column">
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="../pages/authentication/forget-password.html">Forget
                                  Password</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="../pages/authentication/reset-password.html">Reset
                                  Password</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="../pages/authentication/otp-varification.html">Otp
                                  Varification </a>
                          </li>
                      </ul>
                  </li>
