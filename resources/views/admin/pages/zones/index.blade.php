...
<a href="{{ route('admin.zones.create') }}" class="btn btn-primary mb-3">Tambah Zona</a>
<hr>

<form action="{{ route('admin.zones.index') }}" method="GET" class="mb-3">
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.zones.show', $zone->id) }}" class="btn btn-info btn-sm">Lihat</a>
